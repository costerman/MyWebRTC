...
public class MainActivity extends ActionBarActivity
    ...
    //region - Activity Event Callbacks
    @Override
        ...
        switch(sectionNumber){
            case 1:
                fragmentManager.beginTransaction()
                        .replace(R.id.container, DialerFragment.newInstance(sectionNumber))
                        .commit();
                break;
            case 2:
                String roomId = WebRTCApp.getInstance().getRoomId();
                VideoFragment fragment = VideoFragment.getInstance();
                Bundle args = new Bundle();
                args.putInt(MainActivity.ARG_SECTION_NUMBER, sectionNumber);
                args.putString(VideoFragment.ARG_ROOM_ID, roomId);
    ...
    private class SessionNodeListener extends FirebaseChildEventListener {
        @Override
